...
ActiveRecord::Schema.define(:version => 20130311164341) do
  ...
  add_index "closet_items", ["item_id"], :name => "index_closet_items_on_item_id"
  add_index "closet_items", ["user_id"], :name => "index_closet_items_on_user_id"
  ...
  add_index "items", ["measurement_id"], :name => "index_items_on_measurement_id"
  add_index "items", ["style_id"], :name => "index_items_on_style_id"
  ...
  add_index "products", ["brand_id", "identifier"], :name => "index_products_on_brand_id_and_identifier"
